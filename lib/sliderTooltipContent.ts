...
export const SLIDER_TOOLTIP_CONTENT: Record<SliderTooltipKey, string> = {
  ...
  herdReduction:
    "A reduction in cattle numbers proportionally reduces enteric fermentation emissions. Applied linearly to the cattle enteric fermentation pool (~3,157 kt CO₂e, NAEI 2023): a 1% reduction avoids approximately 32 kt CO₂e. The marker on the slider shows the reduction required to close the adjusted gap by this measure alone, without any other intervention.",
  ruminantGenetics:
